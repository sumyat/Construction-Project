<%@ Page Language="C#" MasterPageFile="~/Staff.Master" AutoEventWireup="true" CodeBehind="Bank.aspx.cs" Inherits="Construction.Admin.Bank" Title="Bank" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <asp:GridView ID="gvBank" runat="server" AllowPaging="True" AllowSorting="True"
        AutoGenerateColumns="False" CellPadding="4" DataKeyNames="BankID"
        ForeColor="#333333" GridLines="None" Width="500px" DataSourceID="sqlBank">
        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
        <Columns>
            <asp:BoundField DataField="Code" HeaderText="Code" SortExpression="Code" />
            <asp:BoundField DataField="Description" HeaderText="Description" SortExpression="Description" />
            <asp:HyperLinkField DataNavigateUrlFields="BankID,Code,Description" DataNavigateUrlFormatString="?ID={0}&amp;Status=E&amp;Code={1}&amp;Desp={2}"
                Text="Edit">
                <ItemStyle Width="15px" />
            </asp:HyperLinkField>
            <asp:HyperLinkField DataNavigateUrlFields="BankID,Code,Description" 
        ...
        <asp:SqlDataSource ID="sqlBank" runat="server" ConnectionString="<%$ ConnectionStrings:Construction %>"
            SelectCommand="Select * From Banks Where isDelete = 0"></asp:SqlDataSource>
    </p>
</asp:Content>
