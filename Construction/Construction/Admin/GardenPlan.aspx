<%@ Page Language="C#" MasterPageFile="~/Staff.Master" AutoEventWireup="true" CodeBehind="GardenPlan.aspx.cs" Inherits="Construction.Admin.GardenPlan" Title="Garden Plan" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <p>
    <asp:GridView ID="gvGardenPlan" runat="server" AllowPaging="True" AllowSorting="True"
        AutoGenerateColumns="False" CellPadding="4" 
        ForeColor="#333333" GridLines="None" Width="800px" DataSourceID="sqlGardenPlan">
