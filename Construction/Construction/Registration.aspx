<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Construction.Registration" Title="Customer Registration" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <table style="border:double 3px #909090;" cellpadding="10">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtName" Width="400px">
                </asp:TextBox><asp:RequiredFieldValidator runat="server" ID="rfvDesp"
                ControlToValidate="txtName" Text="*" ErrorMessage="Require User Name." >
                </asp:RequiredFieldValidator>
            </td>
        </tr>
